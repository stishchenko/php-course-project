...
if (isset($_POST['add_message'])) {
    if (!empty($_POST['message'])) {
        if (isset($_SESSION['logged_user'])) {
            addNewMessage($pdo, htmlspecialchars($_POST['message']), $_SESSION['logged_user']->getId());
        } else {
            if (empty($_POST['name'])) {
                $_POST['name'] = ' ';
            }
    ...
    if (!empty($_POST['email']) && !empty($_POST['password'])) {
        if (!filter_var($_POST['email'], FILTER_VALIDATE_EMAIL)) {
            ...
            if ($user) {
                ...
                $_SESSION['error_message'] = 'Such user don`t exits!';
            }
        }
    } else {
        if (empty($_POST['email']) && !empty($_POST['password'])) {
...
<div class="container">
    <div class="row">
        <div class="col-8 me-3">
                    ...
                    foreach ($messages as $message) : ?>
                        <li class="list-group-item">
                            ...
                            <?php if (isset($_SESSION['logged_user']) &&
                                $_SESSION['logged_user']->getRole() == 'admin'): ?>
            ...
            <?php if (isset($_SESSION['logged_user']) && $_SESSION['logged_user']->getRole() == 'admin'): ?>
                ...
                <div class="mb-3">
                    <?php if (isset($_SESSION['logged_user'])): ?>
                        <label class="form-label">Name:
                            <strong><?= $_SESSION['logged_user']->getName(); ?></strong></label>
                    <?php else: ?>
